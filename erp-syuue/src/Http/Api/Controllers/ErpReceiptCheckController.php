...
namespace Newbee\Syuue\Http\Api\Controllers;

use DB;
use Illuminate\Http\Request;
// use Newbee\Syuue\Exports\ReceiptCheckExport;
use Newbee\Syuue\Http\Api\Services\ReceiptCheck\ErpReceiptCheckUpdateService;
use Newbee\Syuue\Http\Api\Base\Controller;
use Newbee\Syuue\Models\ErpReconciliation;
use Newbee\Syuue\Transformers\ErpReceiptCheckTransformers;
